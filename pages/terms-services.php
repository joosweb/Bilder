<div class="container">
      <div class="row">
        <div class="col-sm-12">
        <p>
        	<textarea id="Policy" rows=100 class="marketing-textarea policy-textarea" style="padding:20px; width:100%; height:100%;" disabled>
...
Este sitio web es operado por bilder.cl, Incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
...
Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Normilla 150, chillan, BI, 1234567, Chile.
...
Preguntas acerca de los Términos de Servicio deben ser enviadas a preguntas@bilder.cl.
</textarea>
        </p>
        </div>
     </div>
